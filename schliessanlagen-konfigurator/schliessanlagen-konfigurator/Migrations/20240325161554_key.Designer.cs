...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("schliessanlagen_konfigurator.Models.OrdersOpen.KeyValue", b =>
                {
                    ...
                    b.Property<int?>("Open_OrderId")
                        .HasColumnType("int");

                    b.Property<bool>("isOpen")
                        .HasColumnType("bit");

                    b.Property<int>("isOpen_valueId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("isOpen_valueId");
            ...
            modelBuilder.Entity("schliessanlagen_konfigurator.Models.OrdersOpen.KeyValue", b =>
                {
                    b.HasOne("schliessanlagen_konfigurator.Models.OrdersOpen.isOpen_value", "isOpen_value")
                        .WithMany("KeyValue")
                        .HasForeignKey("isOpen_valueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
