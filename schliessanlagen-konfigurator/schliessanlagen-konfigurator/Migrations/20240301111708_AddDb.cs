        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HebelzylinderOptionsId = table.Column<int>(name: "Hebelzylinder_OptionsId", type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Halbzylinder_Options", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Halbzylinder_Options_Hebelzylinder_Options_Hebelzylinder_OptionsId",
                        column: x => x.HebelzylinderOptionsId,
                        principalTable: "Hebelzylinder_Options",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Halbzylinder_Options_Hebelzylinder_OptionsId",
                table: "Halbzylinder_Options",
                column: "Hebelzylinder_OptionsId");
