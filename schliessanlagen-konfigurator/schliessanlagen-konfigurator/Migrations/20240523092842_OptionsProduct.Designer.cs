...
namespace schliessanlagen_konfigurator.Migrations
{
    ...
    [Migration("20240523092842_OptionsProduct")]
    partial class OptionsProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "68f568f0-a69c-4007-ac6a-7c7704070090",
                            Name = "admin",
                            NormalizedName = "admin"
                        },
                        new
                        {
                            Id = "14fc2462-34e5-40ee-8f7a-7e0042a61d19",
                            Name = "client",
                            NormalizedName = "client"
                        },
                        new
                        {
                            Id = "6f7b85c8-30a8-4f5d-9f8d-846e34b634de",
                            Name = "admin",
                            NormalizedName = "admin"
                        },
                        new
                        {
                            Id = "8553a14a-2fd0-4533-923a-ea57f7c9b090",
                            Name = "client",
                            NormalizedName = "client"
                        });
                });
            ...
            modelBuilder.Entity("schliessanlagen_konfigurator.Models.Users.ProductOptions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("productSysteamId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("productSysteamId");

                    b.ToTable("ProductOptions");
                });

            modelBuilder.Entity("schliessanlagen_konfigurator.Models.Users.ProductOptionsValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("NameOptions")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProductOptionsId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("ProductOptionsId1")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("schliessanlagen_konfigurator.Models.Users.ProductOptions", b =>
                {
                    b.HasOne("schliessanlagen_konfigurator.Models.Users.ProductSysteam", "productSysteam")
                        .WithMany("Options")
                        .HasForeignKey("productSysteamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("schliessanlagen_konfigurator.Models.Users.ProductOptionsValue", b =>
                {
                    b.HasOne("schliessanlagen_konfigurator.Models.Users.ProductOptions", "ProductOptions")
                        .WithMany("Options")
