...
namespace schliessanlagen_konfigurator.Models.ProfilDopelZylinder
{
    public class Witterungsschutz
    {
        ...
        public ICollection<Witterungsschutz_Value> Witterungsschutz_Value { get; set; }
        public Witterungsschutz()
        {
            Witterungsschutz_Value = new List<Witterungsschutz_Value>();
        }
    }
}
